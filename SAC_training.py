...
model_name = "SAC_ZOO_PARAMS_5past_distance_plus_3_speed_0_new_friction"
...
net_arch = [256,256]
policy_kwargs = dict(activation_fn=torch.nn.ReLU, log_std_init=-1, net_arch=net_arch)
model = SAC("MlpPolicy", env, verbose=1, tensorboard_log=logdir, gamma=0.99, batch_size=512, sde_sample_freq=4,
            use_sde=True, device='cuda', ent_coef='auto', learning_rate=0.00003, policy_kwargs=policy_kwargs)
